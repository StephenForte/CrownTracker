    ...
    {draft && <>
      ...
      <section className="panel" style={{ marginTop: 16 }}>
        ...
        <div className="form-grid">
          ...
          <div className="field wide"><label htmlFor="identityTerms">Required listing identity terms</label><input id="identityTerms" name="identityTerms" placeholder="e.g. factory baguette, grey dial" maxLength={300} /><span className="field-hint">Optional comma-separated terms that must be present in listing evidence. The exact or base reference is always required; dealers may use a bare numeric stem when no conflicting suffix variant appears. Use identity terms for a specific factory configuration.</span></div>
